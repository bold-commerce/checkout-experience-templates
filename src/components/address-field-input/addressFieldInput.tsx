...
export function AddressFieldInput(props: IAddressFieldInputProps): React.ReactElement {
    ...
    const {placeholder, id, name , value, errorMessage, handleChange, handleBlur} = useGetAddressFieldInputData(props.type, props.fieldId, props.debounceApiCall, props.placeholder);
