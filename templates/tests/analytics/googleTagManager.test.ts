...
import {orderCompleteForGoogleTagManager} from 'src/analytics';
...
describe('testing Google Tag Manager functions', () => {
    ...
    test('test orderComplete function', () => {
        orderCompleteForGoogleTagManager(appState.customer, appState.addresses, appState.line_items, appState.currency.iso_code, totals, appState.shipping.selected_shipping, '123', appState.discounts);
